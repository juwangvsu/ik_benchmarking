...
-------9/19/25 rrr fork full ik_benckmarking------------------------------
hpzbook:
urdf:
	rrr_arm_full_fork.urdf
	../moveit_resources_rrr_description/urdf/rrr_arm_full_fork.urdf
ik_benchmarking
	ik_benchmarking_rrrfork.yaml 15 fields (fail) 22 fields [succ]
	(xx) ros2 run ik_benchmarking ik_benchmarking_data_generator.py -c ik_benchmarking_rrrfork.yaml
moveit setup:
...
cd ros2_ws; 
ros2 run ik_benchmarking ik_pub.py -c src/ik_benchmarking/bio_ik_rrrfork.csv -u rrr -l 4
...
issue:
	...
	ik_benchmarking_rrrfork.yaml 15 fields (fail) 22 fields [succ]
		rrrfork_arm_moveit_config/rrrfork_arm/arm
			arm group joints: joint_1, joint_2, joint_3, joint_4, joint_41,joint_42, joint_43
				joint_4f is fixed so not count,  
				not consistant with current urdf 9/19/25, rrrfork_arm_moveit_config tb updated?
	ik_benchmarking_rrr.yaml 11 fields (false case) 14 fields (true case)
		rrr_arm_moveit_config/rrr_arm/arm
			arm group joints: joint_1, joint_2, joint_3
				rrr_arm.srdf
